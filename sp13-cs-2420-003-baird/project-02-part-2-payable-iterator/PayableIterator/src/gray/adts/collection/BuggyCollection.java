 ...
 * <code>BuggyCollection</code> is a simple implementation of the
 ...
 * capacity</li> </UL>
 */
public class BuggyCollection<E> extends java.util.AbstractCollection<E> implements
	Cloneable
{
	 ...
	 */
	public BuggyCollection(Collection<? extends E> c)
	{
		if (c == null)
		{
   ...
   * x.clone() != x
	...
	public Object clone()
	{
		BuggyCollection<E> c = null;
		// 1. clone the entire collection object
		try
		{
			c = (BuggyCollection<E>) super.clone();
		}
	...
	private class BasicIterator implements Iterator<E>
	{
		...
		public void remove()
		{
			...
			// Use BuggyCollection's remove() method to do the
			...
			--cursor;
			BuggyCollection.this.remove(collection[cursor]);
